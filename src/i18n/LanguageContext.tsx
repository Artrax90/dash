...
export const translations = {
  ru: {
    ...
    dashboard: {
      ...
      healthyOnline: 'В норме (Онлайн)',
      ofFleet: '80% парка',
      offline: 'Выключены (Оффлайн)',
      offlineDevices: 'Выключены (Оффлайн)',
      needAttention: '3 требуют внимания',
      problems: 'Проблемы / Внимание',
      warningProblems: 'Проблемы / Внимание',
  ...
  en: {
    ...
    dashboard: {
      ...
      online: 'Online',
      healthyOnline: 'Healthy (Online)',
      ofFleet: '80% of fleet',
      offline: 'Offline',
      offlineDevices: 'Powered Off',
      needAttention: '3 need attention',
      problems: 'Problems / Warning',
      warningProblems: 'Problems / Warning',

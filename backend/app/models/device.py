...
class Device(Base):
    ...
    building = Column(String(100), nullable=True, index=True, default="")
    floor = Column(String(50), nullable=True, index=True, default="")
    room = Column(String(100), nullable=True, index=True, default="")

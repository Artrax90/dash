...
Данная директория содержит готовые PowerShell и Batch скрипты для автоматического обновления агентов до актуальной версии **v2.9.21** отдельно по каждой группе или по всему парку сразу.
